...
### Анализ результатов Модели 3 (CatBoost) и итоговое сравнение моделей

Результаты работы градиентного бустинга CatBoost на отложенной выборке `Test.xlsx` завершают цикл моделирования. Полученные метрики позволяют составить полную картину эффективности алгоритмов и сформировать финальные выводы для HR-отчета и бизнеса.
...
### Финальный аналитический вывод для отчета

Эксперимент наглядно демонстрирует, как разные математические подходы решают проблему экстремального дисбаланса классов, предоставляя бизнесу три разные операционные стратегии:
